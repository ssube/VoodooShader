...
#define VOODOO_LOADER_AUTHOR        VOODOO_GLOBAL_AUTHOR
...
#define VOODOO_LOADER_VERSION_BUILD VOODOO_GLOBAL_VERSION_BUILD
#define VOODOO_LOADER_VERSION_ID         VOODOO_GLOBAL_VERSION_ID
