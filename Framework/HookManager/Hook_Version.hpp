...
#define VOODOO_HOOK_AUTHOR          VOODOO_GLOBAL_AUTHOR
...
#define VOODOO_HOOK_VERSION_BUILD   VOODOO_GLOBAL_VERSION_BUILD
#define VOODOO_HOOK_VERSION_ID      VOODOO_GLOBAL_VERSION_ID
