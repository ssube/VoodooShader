...
#ifndef __EHHook_i_h__
#define __EHHook_i_h__
...
#ifndef __EHHookSystem_FWD_DEFINED__
#define __EHHookSystem_FWD_DEFINED__

#ifdef __cplusplus
typedef class EHHookSystem EHHookSystem;
#else
typedef struct EHHookSystem EHHookSystem;
#endif /* __cplusplus */

#endif 	/* __EHHookSystem_FWD_DEFINED__ */
...
/* interface __MIDL_itf_EHHook_0000_0000 */
/* [local] */ 

#include "VoodooFramework.hpp"


extern RPC_IF_HANDLE __MIDL_itf_EHHook_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_EHHook_0000_0000_v0_0_s_ifspec;
...
#ifndef __EHHookLib_LIBRARY_DEFINED__
#define __EHHookLib_LIBRARY_DEFINED__

/* library EHHookLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_EHHookLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("01C6187C-D3D1-4C0D-8D50-4BC3DA389583")
CompReg;
#endif

EXTERN_C const CLSID CLSID_EHHookSystem;

#ifdef __cplusplus

class DECLSPEC_UUID("D187B7EF-998D-4639-A557-C878EBDC1B90")
EHHookSystem;
#endif
#endif /* __EHHookLib_LIBRARY_DEFINED__ */
