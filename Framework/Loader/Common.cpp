...
/**
 =======================================================================================================================
 * Load a module from the system directory (uses absolute path to guarantee proper file). @param libname The filename
 * (and optionally extension) of the file to load. This may contain a path, but it will be interepreted relative to the
 * system directory. @return A handle to the module if loaded or a null handle otherwise.
 =======================================================================================================================
 */
 ...
 * process and must be called after CoInitialize. @return True if the core was able to be created and initialized,
 * false on errors.
 =======================================================================================================================
 */
...
/**
 =======================================================================================================================
 * Release the global Voodoo core, if it exists, and deallocate all global init parameter strings. @return Always true.
 *
 =======================================================================================================================
 */
...
/**
 =======================================================================================================================
 * Retrieve the global root path for Voodoo from the registry and set the global init params to use it. @return Success
 * of the operation.
 =======================================================================================================================
 */
