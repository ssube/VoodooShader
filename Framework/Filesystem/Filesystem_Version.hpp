...
#define VOODOO_FILESYSTEM_PRETTYNAME    L"Voodoo Windows FileSystem"
#define VOODOO_FILESYSTEM_VERSION_MAJOR 0
#define VOODOO_FILESYSTEM_VERSION_MINOR 4
#define VOODOO_FILESYSTEM_VERSION_PATCH 0
#define VOODOO_FILESYSTEM_VERSION_BUILD VOODOO_GLOBAL_VERSION_BUILD
#define VOODOO_FILESYSTEM_GITID         VOODOO_GLOBAL_GITID
