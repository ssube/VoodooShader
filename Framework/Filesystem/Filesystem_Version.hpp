...
#define VOODOO_FILESYSTEM_VERSION_MAJOR VOODOO_GLOBAL_VERSION_MAJOR
#define VOODOO_FILESYSTEM_VERSION_MINOR VOODOO_GLOBAL_VERSION_MINOR
#define VOODOO_FILESYSTEM_VERSION_PATCH VOODOO_GLOBAL_VERSION_PATCH
