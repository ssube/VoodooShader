...
#define VOODOO_GLOBAL_VERSION_MAJOR     VOODOO_VERSION_MAJOR
#define VOODOO_GLOBAL_VERSION_MINOR     VOODOO_VERSION_MINOR
#define VOODOO_GLOBAL_VERSION_PATCH     VOODOO_VERSION_PATCH
#define VOODOO_GLOBAL_VERSION_BUILD     VOODOO_VERSION_BUILD
#define VOODOO_GLOBAL_VERSION_ID        VOODOO_TOSTRING(VOODOO_VERSION_GIT)
