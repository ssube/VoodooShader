...
#define VOODOO_GLOBAL_VERSION_MAJOR     VOODOO_PROJECT_VERSION_MAJOR
#define VOODOO_GLOBAL_VERSION_MINOR     VOODOO_PROJECT_VERSION_MINOR
#define VOODOO_GLOBAL_VERSION_PATCH     VOODOO_PROJECT_VERSION_PATCH
#define VOODOO_GLOBAL_VERSION_BUILD     0
#define VOODOO_GLOBAL_VERSION_ID        VSTR("framework")
