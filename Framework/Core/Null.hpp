...
/**
 * @file Null.hpp Contains null implementations of all the core plugins. @note
 * These are not exposed to other code or visible by other code. In order to use
 * them, the core library must be loaded as a plugin.
 */
