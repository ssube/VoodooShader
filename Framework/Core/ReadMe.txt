========================================================================
    ACTIVE TEMPLATE LIBRARY : Core Project Overview
========================================================================

AppWizard has created this Core project for you to use as the starting point for
...
Core.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Core.h)
        GUID definitions                                (Core_i.c)
        A type library                                  (Core.tlb)
        Marshaling code                                 (Core_p.c and dlldata.c)

Core.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Core.idl. It will be regenerated by MIDL during compilation.
