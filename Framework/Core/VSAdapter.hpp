...
namespace VoodooShader
{
    ...
    public:
        ...
        VOODOO_METHOD(SetProperty)(_In_ const vchar_t * name, _In_ Variant * const value);
        VOODOO_METHOD(GetProperty)(_In_ const vchar_t * name, _In_ Variant * const value) CONST;
