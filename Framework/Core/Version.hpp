 ...
 * Creates a comma-separated chain of version tokens (not string).
 =======================================================================================================================
 */
#define VOODOO_META_VERSION_CHAIN (token) VOODOO_##token##_VERSION_MAJOR, VOODOO_##token##_VERSION_MINOR, VOODOO_##token##_VERSION_PATCH, \
...
#define VOODOO_META_STRING_VERSION_BASIC(token) \
 VOODOO_META_STRING(VOODOO_##token##_VERSION_MAJOR) "."VOODOO_META_STRING(VOODOO_##token##_VERSION_MINOR) "."VOODOO_META_STRING(VOODOO_##token##_VERSION_PATCH) "."VOODOO_META_STRING(VOODOO_##token##_VERSION_REV) VOODOO_META_DEBUG_STRING
