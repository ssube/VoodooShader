...
public:
 ...
 mRefCount(0)
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::IVoodoo3DDevice8(%p) == %p", realDevice, this);
 ...
 STDMETHOD (BeginScene) ()
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::BeginScene() == %d", hr);
 ...
 STDMETHOD (BeginStateBlock) ()
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::BeginStateBlock() == %d", hr);
 ...
 STDMETHOD (Clear) (DWORD Count, const D3DRECT *pRects, DWORD Flags, D3DCOLOR Color, float Z, DWORD Stencil)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::Clear(%d, %p, %d, %d, %f, %d) == %d", Count, pRects, Flags,
     Color, Z, Stencil, hr
   );
 ...
 STDMETHOD (TestCooperativeLevel) ()
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::TestCooperativeLevel() == %d", hr);
 ...
 STDMETHOD_ (UINT, GetAvailableTextureMem) ()
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetAvailableTextureMem() == %d", mem);

  return mem;
 }
 STDMETHOD (ResourceManagerDiscardBytes) (DWORD Bytes)
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::ResourceManagerDiscardBytes(%d) == UNUSED", Bytes);
 ...
 STDMETHOD (GetDirect3D) (IDirect3D8 **ppD3D8)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetDirect3D(%p) == D3D_OK", *ppD3D8);
 ...
 STDMETHOD (GetDeviceCaps) (D3DCAPS8 *pCaps)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetDeviceCaps(%p) == %d", pCaps, hr);
...
#ifdef _DEBUG
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetDisplayMode(%p) == %d", pMode, hr);
#endif
  return hr;
 }
...
#ifdef _DEBUG
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetCreationParameters(%p) == %d", pParameters, hr);
#endif
  return hr;
 }
 STDMETHOD (SetCursorProperties) (UINT XHotSpot, UINT YHotSpot, IDirect3DSurface8 *pCursorBitmap)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetCursorProperties(%d, %d, %p) == %d", XHotSpot, YHotSpot,
     pCursorBitmap, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateAdditionalSwapChain(%p, %p) == %d",
 ...
 STDMETHOD (Reset) (D3DPRESENT_PARAMETERS8 *pPresentationParameters)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::Reset(%p) == %d", pPresentationParameters, hr);
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::Present(%p, %p, %p, %p) == %d", pSourceRect, pDestRect,
 ...
 STDMETHOD (GetBackBuffer) (UINT BackBuffer, D3DBACKBUFFER_TYPE Type, IDirect3DSurface8 **ppBackBuffer)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetBackBuffer(%d, %d, %p) == %d", BackBuffer, Type, *
     ppBackBuffer, hr
   );
 ...
 STDMETHOD (GetRasterStatus) (D3DRASTER_STATUS *pRasterStatus)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetRasterStatus(%p) == %d", pRasterStatus, hr);
 ...
 STDMETHOD_ (void, SetGammaRamp) (DWORD Flags, const D3DGAMMARAMP *pRamp)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetRasterStatus(%d, %p) == void", Flags, pRamp);
 ...
 STDMETHOD_ (void, GetGammaRamp) (D3DGAMMARAMP *pRamp)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetRasterStatus(%p) == void", pRamp);
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateTexture(%u, %u, %u, %u, %u, %u, %p) == %d", Width,
  ...
  if (SUCCEEDED(hr))
  {
   ...
   // ! @todo Set up the core texture registration for Voodoo Gem and track
   // filenames, hook CreateFile
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateVolumeTexture(%d, %d, %d, %d, %d, %d, %d, %p) == %d",
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateCubeTexture(%u, %u, %u, %u, %u, %p) == %d", EdgeLength,
     Levels, Usage, Format, Pool, *ppCubeTexture, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateVertexBuffer(%u, %u, %u, %u, %p) == %d", Length, Usage,
     FVF, Pool, *ppVertexBuffer, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateIndexBuffer(%u, %u, %u, %u, %p) == %d", Length, Usage,
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateRenderTarget(%u, %u, %u, %u, %u, %p) == %d", Width,
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateDepthStencilSurface(%u, %u, %u, %u, %p) == %d", Width,
 ...
 STDMETHOD (CreateImageSurface) (UINT Width, UINT Height, D3DFORMAT Format, IDirect3DSurface8 **ppSurface)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateImageSurface(%u, %u, %u, %p) == %d", Width, Height,
     Format, *ppSurface, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CopyRects(%p, %p, %u, %p, %p) == %d", pSourceSurface,
 ...
 STDMETHOD (UpdateTexture) (IDirect3DBaseTexture8 *pSourceTexture, IDirect3DBaseTexture8 *pDestinationTexture)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::UpdateTexture(%p, %p) == %d", pSourceTexture,
     pDestinationTexture, hr
   );
 ...
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetFrontBuffer(%p) == UNUSED", pDestSurface);
 ...
 STDMETHOD (SetRenderTarget) (IDirect3DSurface8 *pRenderTarget, IDirect3DSurface8  *pNewZStencil)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetRenderTarget(%p, %p) == %d", pRenderTarget, pNewZStencil,
     hr
   );
 ...
 STDMETHOD (GetRenderTarget) (IDirect3DSurface8 **ppRenderTarget)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetRenderTarget(%p) == %d", *ppRenderTarget, hr);
 ...
 STDMETHOD (GetDepthStencilSurface) (IDirect3DSurface8 **ppZStencilSurface)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetDepthStencilSurface(%p) == %d", *ppZStencilSurface, hr);
 ...
 STDMETHOD (EndScene) ()
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::EndScene() == %d", hr);
 ...
 STDMETHOD (SetTransform) (D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX *pMatrix)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetTransform(%u, %p) == %d", State, pMatrix, hr);
 ...
 STDMETHOD (GetTransform) (D3DTRANSFORMSTATETYPE State, D3DMATRIX *pMatrix)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetTransform(%u, %p) == %d", State, pMatrix, hr);
 ...
 STDMETHOD (MultiplyTransform) (D3DTRANSFORMSTATETYPE State, CONST D3DMATRIX *pMatrix)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::MultiplyTransform(%u, %p) == %d", State, pMatrix, hr);
  ...
  if (SUCCEEDED(hr))
  {
   ...
   {
    VoodooLogger->Log(LL_Info, VOODOO_GEM_NAME, "Unrecognized matrix set (%u).", State);
   }
  }
  return hr;
 }
 STDMETHOD (SetViewport) (CONST D3DVIEWPORT8 *pViewport)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetViewport(%p) == %d", pViewport, hr);
 ...
 STDMETHOD (GetViewport) (D3DVIEWPORT8 *pViewport)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetViewport(%p) == %d", pViewport, hr);
 ...
 STDMETHOD (SetMaterial) (CONST D3DMATERIAL8 *pMaterial)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetMaterial(%p) == %d", pMaterial, hr);
 ...
 STDMETHOD (GetMaterial) (D3DMATERIAL8 *pMaterial)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetMaterial(%p) == %d", pMaterial, hr);

  return hr;
 }
 STDMETHOD (SetLight) (DWORD Index, CONST D3DLIGHT8 *Light)
 {
  HRESULT hr = mRealDevice->SetLight(Index, (CONST D3DLIGHT9 *) Light);

  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetLight(%u, %p) == %d", Index, Light, hr);

  return hr;
 }
 STDMETHOD (GetLight) (DWORD Index, D3DLIGHT8 *Light)
 {
  HRESULT hr = mRealDevice->GetLight(Index, (D3DLIGHT9 *) Light);

  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetLight(%u, %p) == %d", Index, Light, hr);
 ...
 STDMETHOD (LightEnable) (DWORD Index, BOOL Enable)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::LightEnable(%u, %d) == %d", Index, Enable, hr);
 ...
 STDMETHOD (GetLightEnable) (DWORD Index, BOOL *pEnable)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetLightEnable(%u, %d) == %d", Index, *pEnable, hr);
 ...
 STDMETHOD (SetClipPlane) (DWORD Index, CONST float *pPlane)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetClipPlane(%u, %p) == %d", Index, pPlane, hr);
 ...
 STDMETHOD (GetClipPlane) (DWORD Index, float *pPlane)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetClipPlane(%u, %p) == %d", Index, pPlane, hr);
 ...
 STDMETHOD (SetRenderState) (D3DRENDERSTATETYPE State, DWORD Value)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetRenderState(%u, %u) == %d", State, Value, hr);
 ...
 STDMETHOD (GetRenderState) (D3DRENDERSTATETYPE State, DWORD *pValue)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetRenderState(%u, %u) == %d", State, *pValue, hr);
  ...
  * non- functional. @todo Diagnose state blocks, see if they can be translated.
  */
 STDMETHOD (EndStateBlock) (DWORD *pToken)
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::EndStateBlock(%u) == UNUSED", *pToken);
 ...
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DeleteStateBlock(%u) == UNUSED", Token);
 ...
 {
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateStateBlock(%u, %u) == UNUSED", Type, *pToken);
 ...
 STDMETHOD (SetClipStatus) (CONST D3DCLIPSTATUS8 *pClipStatus)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetClipStatus(%p) == %d", pClipStatus, hr);
 ...
 STDMETHOD (GetClipStatus) (D3DCLIPSTATUS8 *pClipStatus)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetClipStatus(%p) == %d", pClipStatus, hr);
 ...
 STDMETHOD (GetTexture) (DWORD Stage, IDirect3DBaseTexture8 **ppTexture)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetTexture(%u, %p) == %d", Stage, *ppTexture, hr);
 ...
 STDMETHOD (GetTextureStageState) (DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD *pValue)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetTextureStageState(%u, %u, %p) == %d", Stage, Type, pValue,
     hr
   );
 ...
 STDMETHOD (SetTextureStageState) (DWORD Stage, D3DTEXTURESTAGESTATETYPE Type, DWORD Value)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetTextureStageState(%u, %u, %u) == %d", Stage, Type, Value,
     hr
   );
 ...
 STDMETHOD (ValidateDevice) (DWORD *pNumPasses)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::ValidateDevice(%u) == %d", *pNumPasses, hr);
 ...
 STDMETHOD (GetInfo) (DWORD DevInfoID, void *pDevInfoStruct, DWORD DevInfoStructSize)
 {
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetInfo(%u, %p, %u) == UNUSED", DevInfoID, pDevInfoStruct,
     DevInfoStructSize
   );
 ...
 STDMETHOD (SetPaletteEntries) (UINT PaletteNumber, CONST PALETTEENTRY *pEntries)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetPaletteEntries(%u, %p) == %d", PaletteNumber, pEntries, hr);
 ...
 STDMETHOD (GetPaletteEntries) (UINT PaletteNumber, PALETTEENTRY *pEntries)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetPaletteEntries(%u, %p) == %d", PaletteNumber, pEntries, hr);
 ...
 STDMETHOD (SetCurrentTexturePalette) (UINT PaletteNumber)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetCurrentTexturePalette(%u) == %d", PaletteNumber, hr);
 ...
 STDMETHOD (GetCurrentTexturePalette) (UINT *PaletteNumber)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetCurrentTexturePalette(%u) == %d", *PaletteNumber, hr);
 ...
 STDMETHOD (DrawPrimitive) (D3DPRIMITIVETYPE PrimitiveType, UINT StartVertex, UINT PrimitiveCount)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DrawPrimitive(%u, %u, %u) == %d", PrimitiveType, StartVertex,
     PrimitiveCount, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DrawIndexedPrimitive(%u, %u, %u, %u, %u) == %d",
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DrawPrimitiveUP(%u, %u, %p, %u) == %d", PrimitiveType,
     PrimitiveCount, pVertexStreamZeroData, VertexStreamZeroStride, hr
   );
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME,
     "IVoodoo3DDevice8::DrawIndexedPrimitiveUP(%u, %u, %u, %u, %p, %u, %p, %u) == %d", PrimitiveType,
  ...
  )
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::ProcessVertices(%u, %u, %u, %p, %u) == %d", SrcStartIndex,
     DestIndex, VertexCount, pDestBuffer, Flags, hr
   );
 ...
 STDMETHOD (CreateVertexShader) (CONST DWORD *pDeclaration, CONST DWORD *pFunction, DWORD  *pHandle, DWORD Usage)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreateVertexShader(%u, %u, %u, %u) == %d", *pDeclaration, *
     pFunction, *pHandle, Usage, hr
   );
 ...
 STDMETHOD (SetVertexShader) (DWORD Handle)
 {
  ...
  // ! @todo Test the shader handling further;
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetVertexShader(%u) == %d", Handle, hr);
 ...
 STDMETHOD (GetVertexShader) (DWORD *pHandle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetVertexShader(%d) == D3D_OK", *pHandle);
 ...
 STDMETHOD (DeleteVertexShader) (DWORD Handle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DeleteVertexShader(%u) == %d", Handle, hr);
 ...
 STDMETHOD (SetVertexShaderConstant) (DWORD Register, CONST void *pConstantData, DWORD ConstantCount)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetVertexShaderConstant(%u, %p, %u) == %d", Register,
     pConstantData, ConstantCount, hr
   );
 ...
 STDMETHOD (GetVertexShaderConstant) (DWORD Register, void *pConstantData, DWORD ConstantCount)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetVertexShaderConstant(%u, %p, %u) == %d", Register,
     pConstantData, ConstantCount, hr
   );
 ...
 STDMETHOD (GetVertexShaderDeclaration) (DWORD Handle, void *pData, DWORD *pSizeOfData)
 {
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetVertexShaderDeclaration(%u, %p, %u) == UNUSED", Handle,
     pData, *pSizeOfData
   );
 ...
 STDMETHOD (GetVertexShaderFunction) (DWORD Handle, void *pData, DWORD *pSizeOfData)
 {
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetVertexShaderFunction(%u, %p, %u) == UNUSED", Handle,
     pData, *pSizeOfData
   );
 ...
 /**
  * @note DX8 does not use the concept of stream source offset, so
  * IVoodoo3DDevice8::SetStreamSource always 0 as the offset.
  */
 STDMETHOD (SetStreamSource) (UINT StreamNumber, IDirect3DVertexBuffer8 *pStreamData, UINT Stride)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetStreamSource(%u, %p, %u) == %d", StreamNumber,
     pStreamData, Stride, hr
   );
 ...
 /**
  * @note DX8 does not use the concept of stream source offset, so
  * IVoodoo3DDevice8::GetStreamSource discards the offset during retrieval. Since
  * SetStreamSource uses 0 as the offset, there should be no issues with this.
 ...
 STDMETHOD (GetStreamSource) (UINT StreamNumber, IDirect3DVertexBuffer8 **ppStreamData, UINT *pStride)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetStreamSource(%u, %p, %u) == %d", StreamNumber, *
     ppStreamData, *pStride, hr
   );
 ...
 STDMETHOD (SetIndices) (IDirect3DIndexBuffer8 *pIndexData, UINT BaseVertexIndex)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetIndices(%p, %u) == %d", pIndexData, BaseVertexIndex, hr);
 ...
 STDMETHOD (GetIndices) (IDirect3DIndexBuffer8 **ppIndexData, UINT   *pBaseVertexIndex)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetIndices(%p, %u) == %d", *ppIndexData, *pBaseVertexIndex,
     hr
   );
 ...
 STDMETHOD (CreatePixelShader) (CONST DWORD *pFunction, DWORD  *pHandle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::CreatePixelShader(%p, %u) == %d", pFunction, *pHandle, hr);
 ...
 STDMETHOD (SetPixelShader) (DWORD Handle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetPixelShader(%u) == %d", Handle, hr);
 ...
 STDMETHOD (GetPixelShader) (DWORD *pHandle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetPixelShader(%u) == D3D_OK", *pHandle);
 ...
 STDMETHOD (DeletePixelShader) (DWORD Handle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DeletePixelShader(%u) == %d", Handle, hr);
 ...
 STDMETHOD (SetPixelShaderConstant) (DWORD Register, CONST void *pConstantData, DWORD ConstantCount)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::SetPixelShaderConstant(%u, %p, %u) == %d", Register,
     pConstantData, ConstantCount, hr
   );
 ...
 STDMETHOD (GetPixelShaderConstant) (DWORD Register, void *pConstantData, DWORD ConstantCount)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetPixelShaderConstant(%u, %p, %u) == %d", Register,
     pConstantData, ConstantCount, hr
   );
 ...
 STDMETHOD (GetPixelShaderFunction) (DWORD Handle, void *pData, DWORD *pSizeOfData)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::GetPixelShaderFunction(%u, %p, %u) == UNUSED", Handle,
     pData, *pSizeOfData
   );
 ...
 STDMETHOD (DrawRectPatch) (UINT Handle, CONST float *pNumSegs, CONST D3DRECTPATCH_INFO *pRectPatchInfo)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DrawRectPatch(%u, %p, %p) == %d", Handle, pNumSegs,
     pRectPatchInfo, hr
   );
 ...
 STDMETHOD (DrawTriPatch) (UINT Handle, CONST float *pNumSegs, CONST D3DTRIPATCH_INFO *pTriPatchInfo)
 {
  ...
  VoodooLogger->Log
   (
    LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DrawTriPatch(%u, %p, %p) == %d", Handle, pNumSegs,
     pTriPatchInfo, hr
   );
 ...
 STDMETHOD (DeletePatch) (UINT Handle)
 {
  ...
  VoodooLogger->Log(LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DDevice8::DeletePatch(%u) == %d", Handle, hr);
