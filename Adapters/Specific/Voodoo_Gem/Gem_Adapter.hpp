...
public:
  ...
  /**
   * Binds a Direct3D9 device to this adapter for use in various rendering calls.
   * Without a device, the adapter has no access to graphics. @param device The D3D
