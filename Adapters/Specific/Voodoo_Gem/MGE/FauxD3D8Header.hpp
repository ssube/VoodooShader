...
DECLARE_INTERFACE_(IDirect3DDevice8, IUnknown)
{
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (D3DPRESENT_PARAMETERS8 * pPresentationParameters, IDirect3DSwapChain8 **pSwapChain) PURE;
 ...
 /*~~~~~~~~~~~~~~~*/
 (CONST RECT * pSourceRect, CONST RECT * pDestRect, HWND hDestWindowOverride, CONST RGNDATA * pDirtyRegion) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~*/
 (UINT Width, UINT Height, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DTexture8 **ppTexture) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (UINT EdgeLength, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DCubeTexture8 **ppCubeTexture) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (UINT Length, DWORD Usage, DWORD FVF, D3DPOOL Pool, IDirect3DVertexBuffer8 **ppVertexBuffer) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (UINT Length, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, IDirect3DIndexBuffer8 **ppIndexBuffer) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample, IDirect3DSurface8 **ppSurface) PURE;
 ...
 (
  IDirect3DSurface8 *
  pSourceSurface, CONST RECT *
  pSourceRectsArray, UINT cRects, IDirect3DSurface8 *
  pDestinationSurface, CONST POINT * pDestPointsArray
 ) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~*/
 (IDirect3DBaseTexture8 * pSourceTexture, IDirect3DBaseTexture8 * pDestinationTexture) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (D3DPRIMITIVETYPE, UINT minIndex, UINT NumVertices, UINT startIndex, UINT primCount) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~*/
 (D3DPRIMITIVETYPE PrimitiveType, UINT PrimitiveCount, CONST void *pVertexStreamZeroData, UINT VertexStreamZeroStride) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (
  D3DPRIMITIVETYPE PrimitiveType, UINT MinVertexIndex, UINT NumVertexIndices, UINT PrimitiveCount, CONST void *
   pIndexData, D3DFORMAT IndexDataFormat, CONST void *pVertexStreamZeroData, UINT VertexStreamZeroStride
 ) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~*/
 (UINT SrcStartIndex, UINT DestIndex, UINT VertexCount, IDirect3DVertexBuffer8 * pDestBuffer, DWORD Flags) PURE;
 ...
 /*~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 (CONST DWORD * pDeclaration, CONST DWORD * pFunction, DWORD * pHandle, DWORD Usage) PURE;
...
DECLARE_INTERFACE_(IDirect3D8, IUnknown)
{
 ...
 /*~~~~~~~~~~~~~~~~~~~~*/
 (
  UINT Adapter, D3DDEVTYPE DeviceType, HWND hFocusWindow, DWORD BehaviorFlags, D3DPRESENT_PARAMETERS8 *
  pPresentationParameters, IDirect3DDevice8 **ppReturnedDeviceInterface
 ) PURE;
};
#endif /* VOODOO_GEM_FAUXD3D8HEADER_HPP */
