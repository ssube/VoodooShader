...
public:
  ...
  *
  */
 ~ IVoodoo3DTexture8(void)  { VoodooCore->RemoveTexture(mName); }
 ...
 STDMETHOD (GetSurfaceLevel) (UINT level, IDirect3DSurface8 **ppSurfaceLevel)
 {
  ...
  VoodooLogger->Log
   (
    VoodooShader::LL_Debug, VOODOO_GEM_NAME, "IVoodoo3DTexture8::GetSurfaceLevel(%u, %p) == %d", level, *
     ppSurfaceLevel, hr
   );
