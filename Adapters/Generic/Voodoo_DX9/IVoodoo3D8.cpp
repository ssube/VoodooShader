...
public:
    ...
    */
    IVoodoo3D8::IVoodoo3D8(IDirect3D9 *realObject) :
      ...
      // IUnknown methods
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::QueryInterface(REFIID riid, void **ppvObj)
      {
          return mRealObject->QueryInterface(riid, ppvObj);
      }
      ULONG STDMETHODCALLTYPE IVoodoo3D8::AddRef()
      {
          return mRealObject->AddRef();
      }
      ULONG STDMETHODCALLTYPE IVoodoo3D8::Release()
      {
          ...
          )
      {
          ...
          else
          {
              ...
              gpVoodooDX89 = (VoodooShader::Adapter *) new VoodooShader::DirectX89::Adapter(gpVoodooCore, mRealDevice);
      ...
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::EnumAdapterModes(UINT Adapter, UINT Mode, D3DDISPLAYMODE * pMode)
      {
      ...
      UINT STDMETHODCALLTYPE IVoodoo3D8::GetAdapterCount()
      {
      ...
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::GetAdapterDisplayMode(UINT Adapter, D3DDISPLAYMODE * pMode)
      {
      ...
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::GetAdapterIdentifier(UINT Adapter, DWORD Flags, D3DADAPTER_IDENTIFIER8 * pIdentifier)
      {
      ...
      UINT STDMETHODCALLTYPE IVoodoo3D8::GetAdapterModeCount(UINT Adapter)
      {
      ...
      HMONITOR STDMETHODCALLTYPE IVoodoo3D8::GetAdapterMonitor(UINT Adapter)
      {
      ...
      * }
      */
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::GetDeviceCaps(UINT Adapter, D3DDEVTYPE DeviceType, D3DCAPS8 * pCaps)
      {
          *pCaps = d3d8Caps;
      ...
      */
      HRESULT STDMETHODCALLTYPE IVoodoo3D8::RegisterSoftwareDevice(void *pInitializeFunction)
      {
