...
public:
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::BeginScene() == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::BeginStateBlock() == %s\n")
			.With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::Clear(%d, %d, %d, %d, %d == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::TestCooperativeLevel() == %s\n")
		.With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetAvailableTextureMem() == %s\n")
		.With(mem).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetDeviceCaps(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetDisplayMode(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetCreationParameters(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetCursorProperties(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::ShowCursor(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateAdditionalSwapChain(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::Reset(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::Present(%d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetBackBuffer(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetRasterStatus(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateTexture(%d, %d, %d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateVolumeTexture(%d, %d, %d, %d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateCubeTexture(%d, %d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateVertexBuffer(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateIndexBuffer(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateRenderTarget(%d, %d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateDepthStencilSurface(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateImageSurface(%d, %d, %d, %d) == %s\n")
		.With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CopyRects(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::UpdateTexture(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetRenderTarget(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetRenderTarget(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetDepthStencilSurface(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::EndScene() == %s\n")
		.With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetTransform(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetTransform(%d, %d) == %s\n")
		.With(State).With(pMatrix).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::MultiplyTransform(%d, %d) == %s\n")
		.With(State).With(pMatrix).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetViewport(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetViewport(%d) == %s\n")
		.With(pViewport).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetMaterial(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetMaterial(%d) == %s\n")
		.With(pMaterial).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetLight(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetLight(%d, %d) == %s\n")
		.With(Index).With(Light).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::LightEnable(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetLightEnable(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetClipPlane(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetClipPlane(%d, %d) == %s\n")
		.With(Index).With(pPlane).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetRenderState(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetRenderState(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::EndStateBlock(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DeleteStateBlock(%d) == %s\n")
	...
	*/
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateStateBlock(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetClipStatus(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetClipStatus(%d) == %s\n")
		.With(pClipStatus).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetTexture(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetTexture(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetTextureStageState(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetTextureStageState(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::ValidateDevice(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetPaletteEntries(%d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetPaletteEntries(%d, %d) == %s\n")
		.With(PaletteNumber).With(pEntries).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetCurrentTexturePalette(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetCurrentTexturePalette(%d) == %s\n")
		.With(*PaletteNumber).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawPrimitive(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawIndexedPrimitive(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawPrimitiveUP(%d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawIndexedPrimitiveUP(%d, %d, %d, %d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::ProcessVertices(%d, %d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreateVertexShader(%d, %d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetVertexShader(%d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DeleteVertexShader(%d) == %s\n")
		.With(Handle).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetVertexShaderConstant(%d, %d, %d) == %s\n")
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetVertexShaderConstant(%d, %d, %d) == %s\n")
		.With(Register).With(pConstantData).With(ConstantCount).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetStreamSource(%d, %d, %d) == %s\n")
		.With(StreamNumber).With(pStreamData).With(Stride).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetStreamSource(%d, %d, %d) == %s\n")
		.With(StreamNumber).With(*ppStreamData).With(*pStride).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetIndices(%d, %d) == %s\n")
		.With(pIndexData).With(BaseVertexIndex).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetIndices(%d, %d) == %s\n")
		.With(*ppIndexData).With(*pBaseVertexIndex).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::CreatePixelShader(%d, %d) == %s\n")
		.With(pFunction).With(*pHandle).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
	...
	{
		HRESULT hr = mRealDevice->SetPixelShader((IDirect3DPixelShader9*)Handle);

#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetPixelShader(%d) == %s\n")
		.With(Handle).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DeletePixelShader(%d) == %s\n")
		.With(Handle).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::SetPixelShaderConstant(%d, %d, %d) == %s\n")
		.With(Register).With(pConstantData).With(ConstantCount).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::GetPixelShaderConstant(%d, %d, %d) == %s\n")
		.With(Register).With(pConstantData).With(ConstantCount).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawRectPatch(%d, %d, %d) == %s\n")
		.With(Handle).With(pNumSegs).With(pRectPatchInfo).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DrawTriPatch(%d, %d, %d) == %s\n")
		.With(Handle).With(pNumSegs).With(pTriPatchInfo).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
...
#ifdef _DEBUG
		VoodooCore->GetLog()->Format("Voodoo DX8.9: IVoodoo3DDevice8::DeletePatch(%d) == %s\n")
		.With(Handle).With(cgD3D9TranslateHRESULT(hr)).Done();
#endif
