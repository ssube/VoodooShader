...
namespace VoodooShader
{
    ...
    {
        /**
         * @clsid f84ac3cb-073f-11e1-83d4-005056c00008
         */
        VOODOO_CLASS(VSTextureOGL, ITexture, ({0xCB, 0xC3, 0x4A, 0xF8, 0x3F, 0x07, 0xE1, 0x11, 0x83, 0xD4, 0x00, 0x50, 0x56, 0xC0, 0x00, 0x08}))
        {
        public:
            VSTextureOGL(_In_ VSBindingOGL * pBinding);
            VSTextureOGL(_In_ VSBindingOGL * pBinding, _In_ CONST String & name, _In_ IDirect3DTexture9 * pTexture);
            ~VSTextureOGL();
        ...
        private:
            ...
            /**
             * Used if this texture is currently bound as a sampling source: will take some value GL_TEXTUREi, as
             * appropriate for glActiveTexture.
             */ 
            GLenum m_BoundSourceSlot;
            /**
             * Used if this texture is currently bound as a render target: will take some value GL_TEXTURE_x, depending on
             * what kind of texture this is (2D, 3D, etc).
             */
            GLenum m_BoundTargetSlot;

            GLint m_ReplacedSource;
