...
namespace VoodooShader
{
    ...
    {
        /**
         * @clsid f84ac3c9-073f-11e1-83d4-005056c00008
         */
        VOODOO_CLASS(VSPassOGL, IPass, ({0xC9, 0xC3, 0x4A, 0xF8, 0x3F, 0x07, 0xE1, 0x11, 0x83, 0xD4, 0x00, 0x50, 0x56, 0xC0, 0x00, 0x08}))
        {
        public:
            VSPassOGL(_In_ VSTechniqueOGL * pTechnique, UINT passId);
            ~VSPassOGL();
            ...
            VOODOO_METHOD(SetTarget)(_In_ CONST uint32_t index, _In_ ITexture * pTarget);
            VOODOO_METHOD(GetShader)(_In_ CONST ShaderStage stage, _In_ Variant * pShader) CONST;
