...
namespace VoodooShader
{
    ...
    {
        #define VOODOO_DEBUG_TYPE VSParameterOGL
        DeclareDebugCache();

        VSParameterOGL::VSParameterOGL(_In_ VSEffectOGL * pEffect, _In_ D3DXHANDLE pParamHandle) :
            m_Refs(0), m_Effect(pEffect), m_DXHandle(pParamHandle)
        {
            if (!m_Effect)
            {
                Throw(VOODOO_OGL_NAME, VSTR("Unable to create effect parameter with no effect."), nullptr);
            }
            ...
            if (!m_Effect)
            {
                Throw(VOODOO_OGL_NAME, VSTR("Unable to create parameter with no hardware effect."), m_Core);
            }
            else if (!m_DXHandle)
            {
                Throw(VOODOO_OGL_NAME, VSTR("Unable to create parameter with no hardware handle."), m_Core);
            }
            ...
            {
                Throw(VOODOO_OGL_NAME, VSTR("Unable to retrieve parameter description."), m_Core);
            }
        ...
        VSParameterOGL::VSParameterOGL(_In_ VSBindingOGL * pBinding, _In_ CONST String & name, _In_ ParameterDesc desc) :
            m_Refs(0), m_Binding(pBinding), m_Effect(nullptr), m_Name(name), m_Desc(desc), m_DXHandle(nullptr)
        {
            if (!m_Binding)
            {
                Throw(VOODOO_OGL_NAME, VSTR("Unable to create virtual parameter with no binding."), nullptr);
            }
        ...
        VSParameterOGL::~VSParameterOGL()
        {
            RemoveThisFromDebugCache();
        }

        uint32_t VOODOO_METHODTYPE VSParameterOGL::AddRef() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
            return SAFE_INCREMENT(m_Refs);
        }

        uint32_t VOODOO_METHODTYPE VSParameterOGL::Release() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VoodooResult VOODOO_METHODTYPE VSParameterOGL::QueryInterface(_In_ CONST Uuid refid, _Outptr_result_maybenull_ IObject ** ppOut)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
            if (!ppOut)
            {
            ...
            else
            {
                ...
                else if (refid == CLSID_VSParameterOGL)
                {
                    *ppOut = static_cast<VSParameterOGL*>(this);
                }
                else
                {
                    *ppOut = nullptr;
        ...
        String VOODOO_METHODTYPE VSParameterOGL::ToString() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        ICore * VOODOO_METHODTYPE VSParameterOGL::GetCore() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        String VOODOO_METHODTYPE VSParameterOGL::GetName() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VoodooResult VOODOO_METHODTYPE VSParameterOGL::GetProperty(_In_ CONST Uuid propid, _Out_ Variant * pValue) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VoodooResult VOODOO_METHODTYPE VSParameterOGL::SetProperty(_In_ CONST Uuid propid, _In_ Variant * pValue)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF_(ParameterDesc, VSParameterOGL::GetDesc)() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetBool)(_Out_ bool * pVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetFloat)(_Out_ float * pVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetInt)(_Out_ int32_t * pVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetString)(_Out_ String * pVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetTexture)(_Out_ ITexture ** ppVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::GetVector)(_Out_ Float4 * pVal) CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::SetBool)(_In_ CONST bool val)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::SetFloat)(_In_ CONST float val)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::SetInt)(_In_ CONST int32_t val)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::SetString)(_In_ CONST String & val)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VOODOO_METHODDEF(VSParameterOGL::SetTexture)(_In_ ITexture * pVal)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
            ...
            if (m_Effect && m_DXHandle)
            {
                ...
                if (FAILED(pVal->GetProperty(PropIds::OGLTexture, &propVar)))
                {
                    m_Core->GetLogger()->LogMessage(VSLog_PlugError, VOODOO_OGL_NAME, StringFormat("Unable to get hardware texture from texture %1%.") << pVal);
                    return VSFERR_INVALIDPARAMS;
                }
                ...
                if (FAILED(hr))
                {
                    m_Core->GetLogger()->LogMessage(VSLog_PlugError, VOODOO_OGL_NAME, StringFormat("Unable to bind texture %1% to parameter %2%.") << pVal << this);
                    return VSFERR_INVALIDCALL;
                }

                m_Core->GetLogger()->LogMessage(VSLog_PlugDebug, VOODOO_OGL_NAME, StringFormat("Bound texture %1% to parameter %2%.") << pVal << this);
            }

            return VSF_OK;
        }

        VOODOO_METHODDEF(VSParameterOGL::SetVector)(_In_ CONST Float4 val)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        bool VOODOO_METHODTYPE VSParameterOGL::IsVirtual() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VoodooResult VOODOO_METHODTYPE VSParameterOGL::AttachParameter(_In_ IParameter * pParam)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        VoodooResult VOODOO_METHODTYPE VSParameterOGL::DetachParameter(_In_ IParameter * pParam)
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        IEffect * VOODOO_METHODTYPE VSParameterOGL::GetEffect() CONST
        {
            VOODOO_DEBUG_FUNCLOG(m_Core->GetLogger());
        ...
        void VOODOO_METHODTYPE VSParameterOGL::Link()
        {
            // Handle textures 
            if (m_Desc.Type >= VSPT_Texture && m_Desc.Type <= VSPT_TextureCube)
            {
        ...
        ITexture * VOODOO_METHODTYPE VSParameterOGL::LinkNewTexture()
        {
            if (m_Desc.Type < VSPT_Texture || m_Desc.Type > VSPT_TextureCube)
            {
                return nullptr;
            ...
            if (srcA && nameA)
            {
                ...
                m_Core->GetLogger()->LogMessage(VSLog_PlugInfo, VOODOO_OGL_NAME, 
